  ...
  return (
    <AboutStyles id="about">
      ...
      <article>
        ...
        <p>Unique: Obtain one of 1,141 unique tech prophecy with
          provable, randomized rarity</p>
          
          <p>Forever bonded: Total commercial usage
          rights granted to NFT owners.
          
          <p>
            Community access: Help shape future
          plans as the Clery and the treasure grow.
            
            </p>
          
          <p>

          Future developments: As more Tech prophecies reveal themselves, so will future utility and
          augmentations. 
          </p>
          ...
          <li>
            3 devout individuals building products and culture
          for Web3. 
            </li>
            <li>

          - This project is meant to grow and evolve with community
          feedback. 
            </li>

            <li>

          We also plan to release open-sources tools and guides to
          help other NFT creators build better, more reliable products. - [Link]
            </li>
            <li>
